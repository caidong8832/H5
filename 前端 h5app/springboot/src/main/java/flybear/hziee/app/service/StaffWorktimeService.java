...
import flybear.hziee.app.mapper.StaffWorktimeMapper;
...
@Service
public class StaffWorktimeService {

    @Autowired
    private StaffWorktimeMapper mapper;
    
    @Autowired
	private SqlRunner sqlRunner;

    public List<StaffWorktime> findAll() {
    ...
    public StaffWorktime findById(Integer id){
		return mapper.selectByPrimaryKey(id);
	}
	
	public Integer update(StaffWorktime entity) throws Exception{
		return mapper.updateByPrimaryKey(entity);
	}

    public Integer save(StaffWorktime entity) {
        return mapper.insert(entity);
    }

    public Map<String, Object> getUIGridData(Map<String, Object> where, Map<String, String> pageMap) {
        SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(StaffWorktime.class);
	...
	public boolean staffWorktimeIsExist(String key){
			SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(StaffWorktime.class);
