...
import flybear.hziee.app.mapper.LabelMapper;
...
public class LabelService {
	...
	public Integer update(Label entity) throws Exception{
		return mapper.updateByPrimaryKey(entity);
	}

    public Integer save(Label entity) {
        return mapper.insert(entity);
    }

    public Map<String, Object> getUIGridData(Map<String, Object> where, Map<String, String> pageMap) {
        SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Label.class);
	...
	public boolean labelIsExist(String key){
			SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Label.class);
