...
import flybear.hziee.app.mapper.ChatMapper;
...
public class ChatService {
	...
	public Integer update(Chat entity) throws Exception{
    ...
    public Map<String, Object> getUIGridData(Map<String, Object> where, Map<String, String> pageMap) {
        SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Chat.class);
	...
	public boolean chatIsExist(String key){
			SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Chat.class);
