...
import flybear.hziee.app.mapper.StaffMapper;
...
public class StaffService {
	...
	public Integer update(Staff entity) throws Exception{
    ...
    public Map<String, Object> getUIGridData(Map<String, Object> where, Map<String, String> pageMap) {
        SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Staff.class);
	...
	public boolean staffIsExist(String key){
			SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Staff.class);
