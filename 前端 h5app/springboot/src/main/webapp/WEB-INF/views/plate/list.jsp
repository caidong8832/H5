	...
	<div data-options="region:'center',border:false">
		<table id="" class="jq-datagrid" fit="true" data-options="{
			...
			columns: [[
				...
				{field:'plateName',title:'姓名',width:100},
				{field:'plateManager',title:'负责医生',width:100},
				{field:'projectNum',title:'挂号次数',width:100},
				{field:'lastEditTime',title:'最后一次操作时间',width:100}
			]]}">
		</table>
	</div>
...
<script type="text/javascript">
	...
	$("#edit,#delete").click(function(){
		...
		if(row == null){
			...
			if(eleId=="edit"){
				App.popup('plate/edit?id='+row.id, {
				title : "编辑",
				width : 610,
				height : 270
			});
			}else if(eleId=="delete"){
	            App.ajax('plate/delete?id='+row.id,{
	            type: "POST"
	            });
