	...
	<div data-options="region:'center',border:false">
		<table id="" class="jq-datagrid" fit="true" data-options="{
			...
			columns: [[
				...
				{field:'reporter',title:'举报者Id',width:100},
				{field:'reportObject',title:'举报对象',width:100},
				{field:'reportTime',title:'举报时间',width:100},
				{field:'reportState',title:'举报状态',width:100},
				{field:'reportAnswer',title:'举报回复',width:100},
				{field:'reportProcess',title:'处理时间',width:100}
			]]}">
		</table>
	</div>
...
<script type="text/javascript">
	...
	$("#edit,#delete").click(function(){
		...
		if(row == null){
			...
			if(eleId=="edit"){
				App.popup('report/edit?id='+row.id, {
				title : "编辑",
				width : 610,
				height : 270
			});
			}else if(eleId=="delete"){
	            App.ajax('report/delete?id='+row.id,{
	            type: "POST"
	            });
