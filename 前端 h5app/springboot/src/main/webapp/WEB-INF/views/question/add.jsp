...
<body>
	...
	<div id="container">
		<form action="question/add" id="form" method="post">
			<div class="wrapper">
				<input type="text" id="search" name="search" placeholder="Search Question" />
				<button type="submit" class="search_btn" id="searchbt"><img src="${__static__}/admin/img/search_icon.png" title="Search" /></button>
			</div>
		</form>
	</div>
